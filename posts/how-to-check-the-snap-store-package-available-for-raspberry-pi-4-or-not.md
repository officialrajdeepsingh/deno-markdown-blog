...
cover_html: <img src="assets/images/the-snap-store.png" alt="How to check the snap store package available for raspberry pi 4 or not?" />
...
![version drop-down list](assets/images/firstway.png)



### Second step

![show architecture drop-down list](assets/images/firstway-2.png)
...
![Linux distribution section](assets/images/secondway.png)
